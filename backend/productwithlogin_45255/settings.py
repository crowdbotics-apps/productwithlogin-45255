"""
Django settings for productwithlogin_45255 project.
...
ROOT_URLCONF = 'productwithlogin_45255.urls'
...
WSGI_APPLICATION = 'productwithlogin_45255.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "productwithlogin_45255 API",
    "DESCRIPTION": "API documentation for productwithlogin_45255 App",
    "VERSION": "v1",
}
